...
Introducing now [`copernicus_data.RData`](./data/copernicus_data.RData), the `.Rdata` object containing the preprocessed set of data used for the analyses. See Section 2 for further details. 
