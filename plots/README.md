...
* Section 5.1: [`heatmap_amortized_Om.png`](./heatmap_amortized_Om.png);
* Section 5.2: [`plot_theta.png`](./plot_theta.png), [`plot_omega.png`](./plot_omega.png);
* Section 6: [`copernicus_temporal_forecast_points.png`](./copernicus_temporal_forecast_points.png), [`copernicus_interpolation_outsample.png`](./copernicus_interpolation_outsample.png);
...
* Appendix D: [`heatmap_amortized_Y.png`](./heatmap_amortized_Y.png), [`plot_pred.png`](./plot_pred.png), [`plot_sigma.png`](./plot_sigma.png), [`copernicus_forecast_temp.png`](./copernicus_forecast_temp.png), [`copernicus_forecast_rain.png`](./copernicus_forecast_rain.png), [`copernicus_forecast_wind.png`](./copernicus_forecast_wind.png), [`copernicus_forecast_evps.png`](./copernicus_forecast_evps.png), [`copernicus_interpolation_insample.png`](./copernicus_interpolation_insample.png).
